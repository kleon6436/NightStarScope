...
主な利用例:
  ...
  python3 Tools/prepare_srtm.py --input /path/to/dem.tif \
      --output NightScope/Data/elevation_global.bin.z --compress
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="NightScope/Data/elevation_global.bin",
        help="出力バイナリファイルパス（デフォルト: NightScope/Data/elevation_global.bin）",
    )
